...
<a href="img/compare.png" target="_blank"><img src="img/compare.png" alt="测试对比"/></a>
...
**新功能**
- 👨‍👩‍👧‍👦 团队协作系统 - 创建团队、邀请成员、共享 Prompt
- 🖼️ 头像上传 - 支持自定义用户头像
- 📱 移动端适配 - 响应式布局，支持手机访问
- 📊 使用统计 - Token 消耗统计和可视化
- 🤖 AI 分析 - Prompt 质量评估和优化建议

**优化**
- 🔧 编辑器只读模式 - 团队只读 Prompt 禁用编辑
- 🔗 邀请链接优化 - 完整 URL 一键复制
- 🏷️ 权限标记 - Prompt 卡片显示可编辑/只读状态
